...
func generateRpcEnum(funcs []string) bool {
	...
	if file.IsExist(K_RpcFuncFile_C) {
		MakeFile(enums, K_EnumOutDir_C, K_EnumFileName+".h", codeEnumTemplate_C)
	}
	if file.IsExist(K_RpcFuncFile_CS) {
		MakeFile(enums, K_EnumOutDir_CS, K_EnumFileName+".cs", codeEnumTemplate_CS)
	}
	MakeFile(enums, K_EnumOutDir, K_EnumFileName+".go", codeEnumTemplate_Go)
	return true
}
...
// -- 填充模板
const (
	codeEnumTemplate_Go = `// Generated by GoServer/src/generat
// Don't edit !
package enum
...
`
	codeEnumTemplate_C = `// Generated by GoServer/src/generat
// Don't edit !
#pragma once
#define Rpc_Enum\
...
`
	codeEnumTemplate_CS = `// Generated by GoServer/src/generat
// Don't edit !
